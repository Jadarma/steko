...
internal class StekoAlgorithm(
    ...
    suspend fun hide(payload: ByteArray, rawPayload: Boolean = true, noise: Boolean = false) {
        ...
        StekoSink(this).buffered().use { sink ->
    ...
    suspend fun show(): Pair<ByteArray, Boolean>? = runCatching {
        val source = StekoSource(this).buffered()
    ...
    companion object {
        ...
        suspend fun createFor(pixels: IntArray, key: Key): StekoAlgorithm {
