...
| `-m`, `--message=<text>`  | Hide the given plain-text string. Ideal for short memos or giving instructions for file attachments. Incompatible with `--raw` mode.                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
|       `-k`, `--key`       | Reuse an existing key instead of generating a new random one. The key is read from _STDIN_ in hexadecimal format.                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
|       `-r`, `--raw`       | When this option is set, exactly one attachment argument is expected. Hides the raw binary contents without any other metadata.                                                                                                                                                                                                                                                                                                                                                                                                                                      |
